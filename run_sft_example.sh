...
prefilter_enable="${PREFILTER_ENABLE:-false}"
prefilter_classifier_path="${PREFILTER_CLASSIFIER_PATH:-./lora_classifier/lora_classifier.pt}"
prefilter_strategy="none"               # Pre-filtering weight policy options: step-level, client-level, shadow-level,evidence-level, none
